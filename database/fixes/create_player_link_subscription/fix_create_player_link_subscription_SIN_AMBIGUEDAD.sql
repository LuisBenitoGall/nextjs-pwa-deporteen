-- CORRECCIÓN: Error "subscription_id is ambiguous"
-- PROBLEMA: En el INSERT de subscription_players, subscription_id puede ser ambiguo
-- SOLUCIÓN: Asegurar que todas las referencias usen alias claros o variables locales
...
begin
  ...
  -- CORRECCIÓN: Usar variables locales (v_subscription_id, v_player_id) en lugar de 
  -- referencias ambiguas a columnas de la tabla de retorno
