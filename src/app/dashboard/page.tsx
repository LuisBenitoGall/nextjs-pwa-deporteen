    ...
    return (
        <div>
            ...
            {subscribed ? (
                ...
                // Usuario con alguna suscripción pero no activa ahora mismo: mostramos estado neutro
                // (sin banner de "Suscríbete", que es exclusivo de "ninguna suscripción")
                <div className="mt-6 rounded-2xl border border-gray-200 p-4 text-center text-gray-600 shadow-sm">
                    <p>{t('suscripcion_activa_sin')}</p>
                    <div className="mt-3">
                        <Link href="/subscription" className="inline-block rounded-lg bg-green-600 px-4 py-2 text-white hover:bg-green-700">
                            {t('suscripciones_gestionar')}
                        </Link>
                    </div>
                </div>
            )}
